...
function PlayRoom (name, countOfToys, maxCostOfToys, ageGroup) {
		this.name = name;
		this.toys = [];
	...
	this.sortToys = function (parameter) {
	...
	this.findToy = function (parameter, valueMin, valueMax) {
		let findedToys = [];
		if (parameter !== undefined) {
	...
	this.fillRoom = function (catalog) {
